    ...
    <div className="min-h-screen bg-[#F8FAFC] pt-28 pb-20 px-4 sm:px-6">
      <div className="max-w-2xl mx-auto animate-pulse">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-[#E2E8F0] p-8 md:p-10">
          <div className="h-7 bg-[#F8FAFC] rounded-lg w-48 mb-8" />
          <div className="space-y-6">
            <div className="h-5 bg-[#F8FAFC] rounded w-24 mb-2" />
            <div className="h-12 bg-[#F8FAFC] rounded-xl w-full" />
            <div className="h-64 bg-[#F8FAFC] rounded-2xl w-full" />
            <div className="h-12 bg-[#F8FAFC] rounded-full w-full" />
          </div>
        </div>
      </div>
    </div>
    ...
    return (
      <div className="min-h-screen bg-[#F8FAFC] pt-28 pb-20 px-4 sm:px-6">
        <div className="max-w-2xl mx-auto text-center py-20">
          <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center mx-auto mb-4 shadow-sm border border-[#E2E8F0]">
    ...
    <div className="min-h-screen bg-[#F8FAFC] pt-28 pb-20 px-4 sm:px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl shadow-xl border border-[#E2E8F0] p-8 md:p-10"
        >
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2.5 px-6 py-3.5 bg-[#1E293B] text-white rounded-full font-body font-medium text-sm hover:bg-[#0284C7] transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
