...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "relative inline-flex items-center justify-center font-body font-semibold rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#84cc16]/40";
  ...
  const variantStyles = {
    primary:
      "bg-[#1a231d] text-[#84cc16] border border-[#84cc16]/40 hover:bg-[#222e26] hover:border-[#84cc16]/60 active:bg-[#222e26]/90 shadow-md shadow-slate-950/30",
    secondary:
